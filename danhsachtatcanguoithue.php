...
<body>
    ...
    <div class="container-fluid">
        ...
        <div>
            ...
            echo '
                    <table class="table cart-table">
                        <thead>
                            ...
                            <th style = "font-size: 20px">Tên người thuê</th>
            ...
            $danhsachtatcanguoithue = new Model();
            $tam = $danhsachtatcanguoithue->getallcarsub();

            $stt = 1;
            foreach ($tam as $item) {
                $hovaten = $item->gethovaten();
                ...
                echo '
                                <tr>
                                    ...
                                    <td style="font-size: 20px">' . $hovaten . '</td>
                                    <td style="font-size: 20px">' . $sodienthoai . '</td>
