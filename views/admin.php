...
<body>
    ...
    <div class="row ">
					...
					<nav class="navbar navbar-expand-lg fixed-top" style="background-color: #5837D0;">
						...
						<div class="collapse navbar-collapse" id="navbarResponsive" >
							<ul class="navbar-nav ml-auto" style="padding-right:50px ;">
                                ...
                                <li class="nav-item active"><a class="nav-link" href="danhsachtatcanguoithue.php" style="font-family: Times New Roman; font-size:22px; color: white;"><span><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-list-task" viewBox="0 0 18 18">
        ...
        <section class="container py-5">
            <div class="row">
                <div class="col-md-12 col-md-12-tilte">
                    <a href = "createcar.php" ><button class = "btn-create" >Create car</button></a>
                </div>
            </div>
