			...
			<div class="row mt-5">
				<div class="col-12 mt-4">
					<div class="card text-white">
					  <img src="./image/bannerDKLT.jpg" class="card-img" alt="Ảnh">
					  <div class="card-img-overlay mt-md-5">
						<h1 class="card-title d-flex justify-content-center mt-md-5">ĐĂNG KÝ LÁI THỬ</h1>
						<p class="card-text"><h5 class="d-flex justify-content-center"><span class="d-none d-lg-block">Đăng ký và đặt lịch lái thử dòng xe bạn mong muốn tại đại lý gần nhất.</span></h5></p>
					  </div>
					</div>
				</div>
			</div>
			<div class="row mx-lg-5">
				<div class="col mx-md-5 mt-5">
					<h5 class="text-center">XIN VUI LÒNG ĐIỀN THÔNG TIN BÊN DƯỚI ĐẠI LÝ TOYOTA GẦN BẠN NHẤT SẼ LIÊN HỆ VỚI BẠN SỚM</h5>
					<form method="post" action="index.php" class="mx-5">
					  	<div class="form-group mx-5">
						  <label for="hovaten">Họ và Tên*</label>
						  <input type="text" class="form-control" id="hovaten" name="hovaten" placeholder="Nguyễn Văn A" required>
						</div>
						<div class="form-group mx-5">
						  <label for="sodienthoai">Số Điện Thoại*</label>
						  <input type="tel" class="form-control" id="sodienthoai" name="sodienthoai" placeholder="0388970719" required>
						</div>
						<div class="form-group mx-5">
						  <label for="tenxe">Tên Xe*</label>
						  <select class="custom-select" id="tenxe" name="tenxe" required>
							<option selected disabled value="">Chọn</option>
							  <?php
							  	foreach($listcars as $car)
								{
									if($car->getid()==$_GET['dklt'])
									{
										echo("<option selected value='".$car->getid()."'>'".$car->getname()."'</option>");
									}
									else
									{
										echo("<option value='".$car->getid()."'>'".$car->getname()."'</option>");	
									}
								}
							  ?>
						  </select>
					  ...
					  <div class="form-group form-check mx-5">
						...
						<div class="form-group form-check mx-5">
						 <input class="form-check-input" type="checkbox" value="" id="check2" name="check" required>
						  <label class="form-check-label" for="check2">
							Tôi đã đọc và đồng ý với các chính sách của Toyota Việt Nam
						  </label>
					  	</div>
						<div class="mx-5 d-flex justify-content-center">
					  <button class="btn btn-primary" type="submit">ĐĂNG KÝ LÁI THỬ</button>
						</div>
					</form>
				</div>
			</div>
			<div class="row rowFooter bg-dark text-white mt-5">
