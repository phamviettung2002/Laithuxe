...
<head>
  ...
  <link rel="stylesheet" href="file.css/viewcar.css">
    ...
    <div class="row row_headcontent" style="padding-top: 80px;">
      ...
      <div class="col-md-7">
        <div style="margin-top:30px; padding:0px 50px;">
          ...
          <div class="price">
            <h3 class="price price_title"><?php echo $car->getprice(); ?> / LẦN (2 GIỜ)</h3> 
          </div>

          <div class="rating" style="margin-top: 40px;">
            <span style="font-size:20px; margin-right: 50px; color: #7a7c7d;">Đánh giá</span>
            <span class="fa fa-star checked_star" style="font-size: 25px;"></span>
            <span class="fa fa-star checked_star" style="font-size: 25px;"></span>
            <span class="fa fa-star checked_star" style="font-size: 25px;"></span>
          ...
          <div class="color-click" style="margin-top: 40px;">
            <span style="font-size:20px; margin-right: 50px; color: #7a7c7d;">Màu sắc</span>
            <span>
              <button class="color color-black" style="margin-right:30px;">Đen</button>
              <button class="color color-white">Trắng</button>
            </span>
          </div>

          <div class="dangkylaixe" style="margin-top: 40px;">
            <span style="font-size:20px; margin-right: 50px; color: #7a7c7d;">Đăng ký</span>
            <span><a href="index.php?dklt=<?php echo $car->getid(); ?>" class="pmrtn btnDangkylaithu" role="button" style="padding: 10px 20px">Đăng ký lái thử</a></span>
          </div>
        </div>
      </div>
    </div>

    <div class="row row_bodycontent">
      <div class="col-md-8 bodycontent_left">
        <div class="product-description">
          <h5 class="product-description_title">MÔ TẢ SẢN PHẨM</h5>
        </div>
        ...
        <div class="product-description">
          <h5 class="product-description_title">BÌNH LUẬN</h5>
        </div>
        <div id="comments-container">
          ...
          foreach ($comments as $comment) {
            if ($displayed_comments >= 5) {
              echo '<div class="comment-card hidden">';
            } else {
              echo '<div class="comment-card">';
              $displayed_comments++;
            }
            echo '<img src="image\avatar.jpg" alt="Avatar" class="avatar">';
            echo '<div class="comment-container">';
            echo '<h4><strong>' . $comment->getName() . '</strong></h4>';
            echo '<p>' . $comment->getComment() . '</p>';
            echo '<span class="comment-date">' . $comment->getdate() . '</span>';
            echo '</div>';
            echo '</div>';
          }
          ?>
        ...
        <script>
          var num_comments = <?php echo $num_comments; ?>;

          var displayed_comments = <?php echo $displayed_comments; ?>;

          document.getElementById("show-more-btn").addEventListener("click", function() {
            var hidden_comments = document.querySelectorAll(".comment-card.hidden");
            for (var i = 0; i < hidden_comments.length; i++) {

              if (displayed_comments < num_comments && i < 5) {
                hidden_comments[i].classList.remove("hidden");
                displayed_comments++;
              } else {
                break;
              }
            }
            if (displayed_comments >= num_comments) {
        ...
        <div class="card">
          <a href="index.php?carid=<?php echo $cartempt1->getid(); ?>" style="text-decoration: none; color: black; height: 100%; width: 100%;">
            ...
            <div class="card-body" style="padding: 10px;">
              ...
              <small class="card-title text-muted">
                <h6><?php echo $cartempt1->gettitle(); ?></h6>
              </small>
              <h5 class="card-title">
                <font color="red"><?php echo $cartempt1->getprice(); ?></font> VND
              </h5>
            </div>
          </a>
        </div>
        ...
        <div class="card" style="top:5px;">
          <a href="index.php?carid=<?php echo $cartempt2->getid(); ?>" style="text-decoration: none; color: black; height: 100%; width: 100%;">
            ...
            <div class="card-body" style="padding: 10px;">
              ...
              <small class="card-title text-muted">
                <h6><?php echo $cartempt2->gettitle(); ?></h6>
              </small>
              <h5 class="card-title">
                <font color="red"><?php echo $cartempt2->getprice(); ?></font> VND
              </h5>
            </div>
          </a>
        </div>
